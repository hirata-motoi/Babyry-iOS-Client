//
//  CellBackgroundViewToEncourageChoose.m
//  babyry
//
...
@implementation CellBackgroundViewToEncourageChoose
...
+ (instancetype)view
    ...
    CellBackgroundViewToEncourageChoose *view = [[[NSBundle mainBundle] loadNibNamed:className owner:nil options:0] firstObject];
